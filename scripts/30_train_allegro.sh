...
python3 tools/patch_train_yaml_extxyz.py allegro/configs/train.yaml dataset/train.extxyz Li La Zr O
nequip-train --config-dir "$PWD/allegro/configs" --config-name train hydra.run.dir="allegro/runs/${RUN_ID}" hydra.job.chdir=False
